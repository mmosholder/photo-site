  ...
  <div v-editable="blok">
    <section class="category sm-pt-25">
      <div class="grid">
        ...
        <div class="row">
          <div :class="[item.size == 'full' ? 'grid-col-xs-6 xs-mb-50 md-mb-100' : 'grid-col-xs-6 grid-col-sm-3 xs-mb-50 md-mb-100']" v-for="(item,i) in blok.images" :key="i" v-if="item.image.length">
